...
\cvcontact{01 02 03 04 05} {img/phone.png} {}
...
\cvneweventdip
	{OpenClassrooms - 2019}
	{\href{https://drive.google.com/open?id=1wHdYcLxh3ZbZAifbl8qyRqhhzMJIYcO3}{Développeur d'application - Python}}
	{\href{https://drive.google.com/open?id=1wHdYcLxh3ZbZAifbl8qyRqhhzMJIYcO3}{Diplôme niveau Bac+3/4.}}
...
\cvrealase
	{En cours}
	{\href{https://github.com/JBthePenguin/FarmManagement}{Outil de gestion pour un producteur de légumes}}
	{\href{https://github.com/JBthePenguin/FarmManagement}{Application web spécifique}}
	...
	{\cvlist {
		...
		\item \textit{Base de données, Versionning}: SQLite - Git\\[-19pt]
...
\cvrealase
	{2019}
	{\href{https://github.com/JBthePenguin/PoilAuNezWebApp}{Site de la compagnie de clown théâtre \textit{Poil au nez}}}
	{\href{https://github.com/JBthePenguin/PoilAuNezWebApp}{Application web - Site vitrine}}
	{\href{https://github.com/JBthePenguin/PoilAuNezWebApp}{Conception, développement, test et mise en ligne sur Heroku.}}
	{\cvlist {
		\item \textit{Backend}: Python - Django\\[-19pt]
		\item \textit{Frontend}: HTML/CSS - Bootstrap, Javascript - JQuery\\[-19pt]
		\item \textit{Base de données, Versionning}: PostgreSQL - Git - TravisCI - selenium\\[-19pt]
...
\cvrealase
	{2018}
	{\href{https://github.com/JBthePenguin/PurBeurreWebApp}{Application en interaction avec l'API \textit{OpenFoodFacts}}}
	{\href{https://github.com/JBthePenguin/PurBeurreWebApp}{Application web - Projet de la formation}}
	{\href{https://github.com/JBthePenguin/PurBeurreWebApp}{Conception, développement, test mise en ligne sur Heroku.}}
	{\cvlist {
		\item \textit{Backend}: Python - Django\\[-18.5pt]
		\item \textit{Frontend}: HTML/CSS - Bootstrap, Javascript - JQuery\\[-18.5pt]
		\item \textit{Base de données, Versionning}: PostgreSQL - Git - selenium\\[-18.5pt]
		\item \textit{Conception, Documentation, Installation}: UML - LaTeX - Herokucli
	}}
